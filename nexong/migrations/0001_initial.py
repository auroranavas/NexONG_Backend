    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.CharField(choices=[('ANNUAL', 'Anual'), ('MENSUAL', 'Mensual'), ('QUARTERLY', 'Trimestral'), ('SIX-MONTHLY', ' Seis Meses')], default='MENSUAL', max_length=11)),
                ('address', models.CharField(blank=True, max_length=255, null=True)),
                ('enrollment_document', models.FileField(upload_to='')),
                ('quota_extension_document', models.FileField(blank=True, null=True, upload_to='')),
                ('birthdate', models.DateField(null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minor_authorization', models.FileField(blank=True, null=True, upload_to='')),
                ('scanned_authorizer_id', models.FileField(blank=True, null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson_evaluations', to='nexong.family')),
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson_evaluations', to='nexong.lesson')),
            ],
        ),
        migrations.CreateModel(
            name='Meeting',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='center_exit_authorizations', to='nexong.event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commentee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments_received', to='nexong.user')),
                ('commenter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments_made', to='nexong.user')),
            ],
        ),
    ]
