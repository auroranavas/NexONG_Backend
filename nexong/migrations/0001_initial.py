    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.IntegerField(default='000000000', validators=[django.core.validators.MaxLengthValidator(9), django.core.validators.MinLengthValidator(9)])),
                ...
                ('postal_code', models.IntegerField(default='00000', validators=[django.core.validators.MinLengthValidator(5), django.core.validators.MaxLengthValidator(5)])),
                ('is_active', models.BooleanField(default=False)),
                ('family', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='nexong.family')),
                ('partner', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='nexong.partner')),
                ('volunteer', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='nexong.volunteer')),
            ],
            options={
                'abstract': False,
            },
