# Generated by Django 5.0.2 on 2024-02-23 10:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('national_ID', models.CharField(blank=True, max_length=9, unique=True)),
                ('nationality', models.CharField(blank=True, max_length=50)),
                ('educative_centre', models.CharField(blank=True, max_length=100)),
                ('educative_centre_tutor', models.CharField(blank=True, max_length=50)),
                ...
                ('phone', models.IntegerField(default='000000000', validators=[django.core.validators.MinValueValidator(9), django.core.validators.MaxValueValidator(9)])),
                ...
                ('postal_code', models.IntegerField(default='00000', validators=[django.core.validators.MinValueValidator(5), django.core.validators.MaxValueValidator(5)])),
                ('is_active', models.BooleanField(default=False)),
                ('family', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='nexong.family')),
                ('partner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='nexong.partner')),
                ('volunteer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='nexong.volunteer')),
            ],
            options={
                'abstract': False,
            },
